                    ...
                    <div class="col-md-12 form-group">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Имя клиента"/>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="clientSurname">Фамилия</label>
                                <input type="text" class="form-control" id="clientSurname" name="clientSurname" placeholder="Фамилия клиента"/>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="clientBirthday">Дата Рождения</label>
                                <input type="date" class="form-control" id="clientBirthday" name="clientBirthday" placeholder="Дата рождения"/>
                            </div>
                        </div>
                        <br><br>
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="clientEmail" name="clientEmail" placeholder="E-mail"/>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="clientPhone">Tелефон</label>
                                <input type="text" class="form-control" id="clientPhone" name="clientPhone" placeholder="Телефон"/>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="clientDiscount">Скидка%</label>
                                <input type="text" class="form-control" id="clientDiscount" name="clientDiscount" placeholder="Скидка%"/>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="clientAddress" name="clientAddress" placeholder="Адрес"/>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="clientZipCode">Индекс</label>
                                <input type="text" class="form-control" id="clientZipCode" name="clientZipCode" placeholder="Индекс"/>
                            </div>
                            <div class="col-md-4 mb-3">
                                <br><br>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div>
                                ...
                                <table class="table table-striped table-bordered table-hover table-responsive" id="clientTable">
                                    <thead>
                                    <tr>

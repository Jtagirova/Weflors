...
public class ProcurementServiceImpl {
    ...
    public List<ProcurementEntity> findAllProcurementsByProductDate(Integer productId, Timestamp date) {
        return procurementRepository.findAllProcurementsByProductIDAndDate(productId, date);
    }
